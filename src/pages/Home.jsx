...
const Home = () => {
  ...
  const renderIcon = (iconName) => {
    switch (iconName) {
      ...
      case "FaBookOpen":
        return <FaBookOpen className="text-blue-600 w-12 h-12 mb-4" />;
      case "FaUsers":
        return <FaUsers className="text-blue-600 w-12 h-12 mb-4" />;
      case "FaBriefcase":
        return <FaBriefcase className="text-blue-600 w-12 h-12 mb-4" />;
      default:
        return null;
    }
  };
